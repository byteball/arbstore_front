  ...
  <main class="mt-5">
    <div class="container pb-5 bg-9 nobgMob">
      ...
      <div class="d-flex align-items-center justify-content-center d-lg-none mb-4">
        <img class="w-75" src="../assets/image/bg-9.png" alt="bg-9">
      </div>
      <div class="row">
        <div class="col-lg-7">
      ...
      <div class="noScrollArrow">
        <div class="row mb-4 mr-0 ml-0 radius-2">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/1.png" alt="1">
          </div>
        </div>
        <div class="row mb-4 mr-0 ml-0 radius-2">
          <div class="bgc-1 col-lg-8">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/2.png" alt="2">
          </div>
        </div>
        <div class="row mb-4 mr-0 ml-0 radius-2">
          <div class="bgc-1 col-lg-8">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/3.png" alt="3">
          </div>
        </div>
        <div class="row mb-4 mr-0 ml-0 radius-2">
          <div class="bgc-1 col-lg-8">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/4.png" alt="4">
          </div>
        </div>
        <div class="row mb-4 mr-0 ml-0 radius-2">
          <div class="bgc-1 col-lg-8">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/5.png" alt="5">
          </div>
        </div>
        <div class="row mb-4 mr-0 ml-0 radius-2">
          <div class="bgc-1 col-lg-8">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/6.png" alt="6">
          </div>
        </div>
        <div class="row mb-4 mr-0 ml-0 radius-2">
          <div class="bgc-1 col-lg-8">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/success.png" alt="success">
          </div>
        </div>
        <div class="row mb-4 mr-0 ml-0 radius-2">
          <div class="bgc-1 col-lg-8">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/from_now_on.png" alt="from_now_on">
          </div>
        </div>
    ...
    <div class="container pb-5 position-relative">
      <div class=" noScrollArrow">
        <div class="row mb-4 mr-0 ml-0 radius-2">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/when_users.png" alt="when_users">
          </div>
        </div>
        <div class="row mb-4 mr-0 ml-0 radius-2">
          <div class="bgc-1 col-lg-8">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/resolving_1.png" alt="1">
          </div>
        </div>
        <div class="row mb-4 mr-0 ml-0 radius-2">
          <div class="bgc-1 col-lg-8">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/resolving_2.png" alt="2">
          </div>
        </div>
        <div class="row mb-4 mr-0 ml-0 radius-2">
          <div class="bgc-1 col-lg-8">
          ...
          <div class="bgc-1 col-lg-4 text-center text-lg-right">
            <img class="w-lg-100" src="../assets/image/arb-guide/resolving_3.png" alt="3">
          </div>
        </div>
      </div>
    </div>
