<template>
    ...
    <div class="row pt-0">
      <div class="col-lg-4 mb-4">
        <div class="f-18 ff-2 bgc-1 radius p-4 position-relative h-100 d-flex flex-column justify-content-between">
          ...
          Download Obyte app
          <div class="ff-1 f-18 color-2 mb-4 mt-4">ArbStore is based on <a href="https://obyte.org" target="_blank" rel="noopener">Obyte</a> cryptocurrency platform (running since 2016). The wallet app will store your money and contracts.</div>
  ...
  <div class="container mt-100 pb-5 bg-12 nobgMob">
    <div class="row">
      <div class="col-lg-8">
        <div class="f-52 ff-2b">
          Perfect privacy
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <div class="d-flex align-items-center justify-content-end d-lg-none">
          <img class="w-100" src="../assets/image/bg-4-1.png" alt="bg-4">
        </div>
      </div>
    </div>
      </div>
